...
<div class="container" id="banner">
	...
	<div class="" style="opacity:60%;float:left;width:500px;margin-left:5%;margin-top:-130px;height:100px;background-color:white;opacity:0.9;">
		<h2><center>Tambah Restoran</center></h2>
	</div>
</div>
<div class="container" id="content">
	  <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url(); ?>Restoran/tambahresto" method="POST"><br/>
